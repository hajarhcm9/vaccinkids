...
class LoginInfirmierActivity : AppCompatActivity() {
    ...
    private val CENTRE_EMAIL    = "admin@centre-essalaam.ma"
    private val CENTRE_PASSWORD = "Admin2024!"

...
router.get(
  ...
  exportDay22.exportVaccinationsPDF,
);
router.get(
  '/vaccinations/excel',
  authMiddleware.authenticate,
  rbacMiddleware.authorize('admin'),
  exportDay22.exportVaccinationsExcel,
);
router.get(
  '/sessions/pdf',
  authMiddleware.authenticate,
  rbacMiddleware.authorize('admin'),
  exportDay22.exportSessionsPDF,
);
router.get(
  '/sessions/excel',
  authMiddleware.authenticate,
  rbacMiddleware.authorize('admin'),
  exportDay22.exportSessionsExcel,
);
router.get(
  '/absenteisme/pdf',
  authMiddleware.authenticate,
  rbacMiddleware.authorize('admin'),
  exportDay22.exportAbsenteismePDF,
);
router.get(
  '/absenteisme/excel',
  authMiddleware.authenticate,
  rbacMiddleware.authorize('admin'),
  exportDay22.exportAbsenteismeExcel,
);
router.get(
  '/stock/excel',
  authMiddleware.authenticate,
  rbacMiddleware.authorize('admin'),
  exportDay22.exportStockExcel,
);

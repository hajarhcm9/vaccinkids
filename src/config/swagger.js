...
const options = {
  definition: {
    ...
    info: {
      ...
      version: "1.0.0",
      description: "API de gestion des rendez-vous de vaccination infantile - Centre de Sante Es-Salaam, Oujda - PFE 2025/2026 ISPITS Oujda",
      contact: {
...
try { var mp = JSON.parse(fs.readFileSync(__dirname+"/swagger-paths.json", "utf8")); Object.assign(specOpenAPI.paths, mp); } catch(e) {}
